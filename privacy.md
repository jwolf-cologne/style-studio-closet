...
- saved looks and planned outfits
- style selfies that you choose to add
- app preferences, style rules, and profile preferences
- local AI usage/cost test records

This information is used to provide the app's core wardrobe, outfit, planning, and personalization features.

## AI Features

Some optional AI features may send selected images and related item details to a backend service in order to:

- remove or improve a clothing photo background
- classify clothing items
- suggest metadata such as category, color, material, or brand
- suggest outfits or styling ideas
- generate try-on related results

AI requests are only made when you use an AI-powered feature. The app does not use your wardrobe photos for public community features.
